...
public class FragmentAniversario extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_aniversario,container,false);


        mRecyclerItem = (RecyclerView) view.findViewById(R.id.rec_Aniversario);
...
*/
    ...
    public List<ItemFornecedor> getListaItem() {
     ...
     List<ItemFornecedor>  item = new ArrayList<>();
        ...
        ItemFornecedor  fotografia = new ItemFornecedor("Fotografia e Vídeo",R.drawable.ic_fotografia);
        ...
        ItemFornecedor  animacao = new ItemFornecedor("Animação e Personagens Vivos",R.drawable.ic_animacao);
        ItemFornecedor  tremzinhos = new ItemFornecedor("Estação de Lanches e Outros",R.drawable.ic_trenzinhos);
        ItemFornecedor  salgados = new ItemFornecedor("Salgados e Doces",R.drawable.ic_salgados);
        ItemFornecedor  fantasias = new ItemFornecedor("Fantasia",R.drawable.ic_fantasy);
        ItemFornecedor  toalhasMesas = new ItemFornecedor("Toalhas de Mesas e Mesas com Cadeiras",R.drawable.ic_toalhas_mesas);
        ItemFornecedor  algodao = new ItemFornecedor("Algodão doce & Maçã do Amor",R.drawable.ic_algodao_doce);
        ItemFornecedor  recreacao = new ItemFornecedor("Pula-Pula e outros Brinquedos",R.drawable.ic_recreacao);
