...
public class HotelActivity extends AppCompatActivity
        implements ContatoListFragment.AoClicarNoHotel,
    ...
    private ContatoListFragment mListFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListFragment = (ContatoListFragment)
    ...
    @Override
    public void clicouNoHotel(Contato contato) {

        if (isTablet()) {

            FragmentCadastroConvidado fragment = FragmentCadastroConvidado.novaInstancia(contato);
            FragmentTransaction ft = mFragmentManager.beginTransaction();
            ft.replace(R.id.detalhe, fragment, FragmentCadastroConvidado.TAG_DETALHE);
            ft.commit();

        } else {

            Intent it = new Intent(this, HotelDetalheActivity.class);
            it.putExtra(HotelDetalheActivity.EXTRA_CONTATO, contato);
            startActivity(it);
    ...
    @Override
    public void salvouHotel(Contato contato) {
        mListFragment.adicionar(contato);
    }
