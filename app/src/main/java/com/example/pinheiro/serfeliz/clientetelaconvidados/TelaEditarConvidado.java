...
public class TelaEditarConvidado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_editar_convidado);
...
if (convidado != null){
    ...
    Log.d("convidado",convidado.getNome());

    edtCadastroConvidadoNome.setText(convidado.getNome());
    nomeConvidado = edtCadastroConvidadoNome.getText().toString();

    edtCadastroConvidadoCelular.setText(convidado.getCelularConvidado());
    celularConvidado = edtCadastroConvidadoCelular.getText().toString();

    edtConvidadoCrianca.setText(convidado.getQtdeAcompanhantesCriancas());
    qtdeAcompanhantesCriancas = edtConvidadoCrianca.getText().toString();

    edtConvidadoAdulto.setText(convidado.getQtdeAcompanhantesAdultos());
    qtdeAcompanhantesAdultos = edtConvidadoAdulto.getText().toString();

    tipoConvidado = convidado.getTipoConvidado();
    numeroConvidado = convidado.getId();
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                                            R.array.grupo, android.R.layout.simple_spinner_dropdown_item);
        ...
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (posicao.equals("0")) {
                    ...
                    tipoConvidado = "Parentes";

                } else if (posicao.equals("2")) {
                    tipoConvidado = "Amigos";

                } else if (posicao.equals("3")) {
                    tipoConvidado = "Vizinhos";

                } else if (posicao.equals("4")) {
                    tipoConvidado = "Colegas";

                } else if (posicao.equals("5")) {
                    tipoConvidado = "Conhecidos";

                } else if (posicao.equals("6")) {
                    tipoConvidado = "Outros";
    ...
    private void validaCampos() {
        ...
        if (isCampoVazio(nomeConvidado)) {
            ...
            Toast.makeText(TelaEditarConvidado.this, "por favor informe o nome do convidado", Toast.LENGTH_LONG).show();
        ...
        if (isCampoVazio(tipoConvidado)) {
            ...
            Toast.makeText(TelaEditarConvidado.this, "por favor informe o Grupo do Convidado(a)", Toast.LENGTH_LONG).show();
        ...
        if (ok) {
            ...
            Toast.makeText(TelaEditarConvidado.this, uidCliente, Toast.LENGTH_LONG).show();

            TelaEditarConvidado.MyTelaCadastroConvidado myFragmentCadastro = new TelaEditarConvidado.MyTelaCadastroConvidado(convidado);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_CONTACT_REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(TelaEditarConvidado.this, number + nome, Toast.LENGTH_SHORT).show();
    ...
    Convidado novoConvidado = new Convidado();
        ...
        protected String doInBackground(String... strings) {
            ...
            mFirestore.collection("cliente")
                    ...
                    .update("nome",nomeConvidado,
                            "celularConvidado",celularConvidado,
                            "qtdeAcompanhantesAdultos",qtdeAcompanhantesAdultos,
                            "qtdeAcompanhantesCriancas",qtdeAcompanhantesCriancas,"tipoConvidado",
                            tipoConvidado)
                    ...
                    .addOnSuccessListener( new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            startActivity(new Intent(TelaEditarConvidado.this, TelaConvidado.class));
                            finish();


                            Toast.makeText(TelaEditarConvidado.this,
